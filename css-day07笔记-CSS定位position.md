...
> 第01阶段.WEB基础：css-day07笔记-CSS定位position
...
- **静态定位**是元素的默认定位方式，无定位的意思。它相当于 border 里面的none，静态定位static，不要定位的时候用。
...
5、中间长方形椭圆 ul的定位（水平居中，离底部15px）

6、长方形需要五个小圆点，ul无序列表，li浮动，椭圆中小圆点的样式



<img src='images/淘宝轮播图--步骤.png'>
